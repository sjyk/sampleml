...
However, prior work in data cleaning applies active learning to most efficiently clean an entire dataset--independent of the user's desired analysis after data cleaning.
In contrast, for an important class of analytics defined by convex-loss models, \sys cleans records that maximally affect the results of the subsequent analytics.
...
Consequently, we propose a gradient descent model update technique that provably avoids this problem.
