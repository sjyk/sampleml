...
In Section \ref{dist-samp}, we describes a solution to problem (2).
...
We now present the problem statements (Section \ref{statements}) and system architecture (Section \ref{arch}) separately.
