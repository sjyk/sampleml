...
We believe that this problem is important for two reasons: (1) any model trained on a mix of dirty and clean data is theoretically affected but the analyst could not know this without cleaning the full dataset, (2) even if this is not a problem this particular converges slowly in practice (Section \ref{real-errors}).
The magnitude of the bias depends on the data distribution, the amount of data cleaning, and particulars of the statistical model.
