...
\reminder{Their goal needs to be clearer.  Is it that the status field is dirty and they want to clean it to find the corrupt donations, or something else?  Why would they want to clean the other attributes?}
...
\reminder{What needed to be cleaned for propublica?  What needs to be cleaned for the classifier?}
