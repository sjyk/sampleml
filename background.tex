...
This does not cover errors that simultaneously affect multiple records such as record deduplication or schema transformation problems.
We represent this record-by-record operation as $C(\cdot)$ which can be applied to a record $r$ to recover $r_{clean} = C(r)$.
