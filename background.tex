...
We represent the data cleaning operation as general user-defined function $Clean(\cdot)$ which can be applied to a record $r$ to recover a unique clean record $r' = Clean(r)$ with the same schema or remove the record $\emptyset = Clean(r)$.
