...
The error in this estimate (i.e. L2 difference w.r.t a model trained on a fully cleaned dataset) should be bounded by a monotonically decreasing function in $k$ (i.e., more cleaning results is expected to improve the model).
\end{problem}
