...
This section describes the need to consider data cleaning when training predictive models, and formalizes the class of predictive models (convex loss) that we explore in this work.
