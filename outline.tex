...
\begin{abstract}
Studies have shown that analysts working with dirty data often repeatedly alternate between analysis and cleaning until a desired accuracy is achieved.
We explore this procedure in the context of statistical model training.  
Training high-dimensional statistical models on partially clean data lacks guarantees, and this process may actually diverge.
We propose \sys which allows for progressive and iterative cleaning for statistical modeling problems while preserving convergence guarantees.
...
We evaluate \sys on five real-world datasets UCI Adult, UCI EEG, MNIST, Dollars For Docs, and WorldBank with both real and synthetic errors.
