...
\begin{abstract}
Data cleaning is often an important step to ensure that statistical models, such as regression and classification, are not affected by errors such as inconsistent, out-of-date, or outlier data.
...
However, many data cleaning workflows can introduce subtle biases into the training process.
...
\sys supports a popular class of models called convex loss models (e.g., linear regression and SVMs).
