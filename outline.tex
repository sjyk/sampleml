...
One way to address the cost of data cleaning is to apply it progressively, cleaning only as much data as necessary to achieve a desired accuracy.
...
The key insight of our framework, \sys, is for convex loss models, data cleaning can be directly integrated into the iterative stochastic optimization that trains the model allowing us to prove convergence and error bounds.
