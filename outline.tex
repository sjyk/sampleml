...
The key insight of our framework, \sys, is for convex loss models, data cleaning can be applied during model training (i.e., in the Gradient Descent loop) allowing for progressive cleaning while preserving provable properties.
