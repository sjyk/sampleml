...
The growing popularity of predictive models adds additional concerns in managing dirty data as these models are highly sensitive to systematic corruption.
Although errors mitigated through data cleaning, it is often very time consuming.
Consequently data cleaning is often applied progressively; cleaning only as much data as necessary to achieve a desired accuracy.
However, existing model training methodologies can return misleading models when trained on a mix of dirty and clean data.
