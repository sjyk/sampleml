...
\title{ActiveClean: Interactive Data Cleaning For Convex Models}
...
For large datasets, the natural aproach, where the analyst partially cleans a dataset and retrains for evaluation, can be arbitrarily incorrect due to Simpson's paradox.
