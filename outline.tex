...
One approach to making data cleaning more efficient is to leverage knowledge of the downstream data analysis to prioritize those records that are most likely to affect the model.
Increasingly, data analytics consist of statistical analysis and predictive modeling which can be highly sensitive to mixtures of dirty and clean data and sample size.
This paper explores reliable model update procedures for progressive data cleaning.
