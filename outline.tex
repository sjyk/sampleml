...
\title{ActiveClean: Progressive Data Cleaning For Machine Learning}
...
A perennial challenge in these systems is the presence of dirty data -- in the form of missing, duplicate, incorrect or inconsistent values -- which can bias the learning algorithms, leading to incorrect or error-prone predictions.
...
In addition, existing learning algorithms are not suited for training on partially cleaned datasets, which can lead to dramatically incorrect models.
