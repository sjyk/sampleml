...
\begin{abstract}
Predictive models, such as classifiers, are sensitive to systematic error caused by dirty data.
...
The key insight of our framework, \sys, is for convex loss models, data cleaning can be directly integrated into the iterative stochastic optimization that trains the model allowing us to progressively clean while preserving provable properties convergence and error bounds.
