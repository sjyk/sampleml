...
\begin{abstract}
Dirty data, including missing, incorrect, or inconsistent values, is an important challenge in data analytics.
...
This algorithm supports a popular class of models called convex loss models (e.g., linear regression and SVMs).
We also propose a sampling algorithm that leverages the structure of downstream models to prioritize cleaning those records likely to affect the results.
