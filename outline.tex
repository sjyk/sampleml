...
The key insight of our framework, \sys, is for convex loss models, data cleaning can be directly integrated with model training via Stochastic Gradient Descent allowing for progressive cleaning while preserving provable properties.
...
%In a real-world experiment, \sys achieves the same model accuracy as an Active Learning algorithm but cleans 
