...
The next set of experiments evaluate \sys in three real world scenarios, one demonstrating the \emph{a priori} case and the other two for the adaptive detection case.
