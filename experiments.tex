...
The first scenario uses two movie datasets from IMDB\footnote{\tiny \url{ftp://ftp.fu-berlin.de/pub/misc/movies/database/}} and Yahoo that was published \ewu{REFERENCE WHERE THEY ARE FROM}.
...
The IMDB dataset is larger (\ewu{HOW MANY}), but much dirtier because it was collected from a web scraper.  
