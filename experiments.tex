...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.10]{exp/original.png}
 \includegraphics[scale=0.10]{exp/5x5removal.png}
 \includegraphics[scale=0.10]{exp/fuzzy.png}
 \caption{We experiment with two forms of corruption in the MNIST image datasets: 5x5 block removal and making the images fuzzy. \label{mnist-corr}}
\end{figure}
...
\begin{figure}[ht]
\centering
 \includegraphics[scale=0.10]{exp/exp7a.pdf}
 \includegraphics[scale=0.10]{exp/exp7b.pdf}
