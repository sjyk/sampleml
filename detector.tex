...
For example, if records with certain attributes are corrupted, pattern tableaus can be assigned to each class to select a set of possibly corrupted records.
