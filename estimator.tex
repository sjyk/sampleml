\subsection{The Estimator}\label{dist-samp}
...
\subsubsection{Oracle Sampling Problem}
...
In practice, we often do not have an oracle available to us, thus our goal is to approximate the oracle as closely as possible.


\subsubsection{Approximating an Oracle Sampler}\label{sampling}
