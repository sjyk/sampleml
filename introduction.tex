...
Predictive modeling, such as regression and classification, is increasingly popular \cite{bdas, alexandrov2014stratosphere, crotty2014tupleware, hellerstein2012madlib} and can be highly sensitive to dirty data.
