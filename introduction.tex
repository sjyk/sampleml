...
This can facilitate a number of important applications in exploratory data analytics: rapid comparison of different data cleaning techniques, early stopping when cleaning no longer improves results, and interactive data cleaning procedures.
