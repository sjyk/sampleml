...
Analysts widely report that this is a significant and time-consuming problem~\cite{kandel2012,nytimes}, and consequently, it is important to understand the efficiency and correctness such operations.

While many aspects of the pre-processing problem has been well-studied in the context of SQL analytics as \emph{data cleaning}, the results can be very counter-intuitive in statistical models.
...
It is common to use the prelimary analysis on dirty data as a guide to help identify potential errors and design repairs~\cite{kandel2012}.
