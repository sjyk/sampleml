...
Likewise, training on partially cleaned data, where cleaned data is mixed with dirty data, can lead to dramtically incorrect models (Figure \label{update-arch1}).
