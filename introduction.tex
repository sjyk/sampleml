...
\item \textbf{Efficiency} (Section \ref{dist-samp}). We derive a theoretically optimal sampling distribution that minimizes the update error and an approximation to estimate the theoretical optimum. \ewu{Both are experimentally shown to BE GOOD.}
